...
public class EditProfileActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.actfm_EPr_title));
            ...
            public void run() {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(EditProfileActivity.this, toast, Toast.LENGTH_LONG).show();
                            finish();
                        }
                    });
                } catch (IOException e) {
                    DialogUtilities.okDialog(EditProfileActivity.this, getString(R.string.SyP_ioerror),
